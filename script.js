...
function checkLoginState() {
  ...
  if (currentUser) {
    ...
    const profBtnNav = document.getElementById('nav-profile-btn');
    const profBtnMob = document.getElementById('mob-profile-btn');

    if (isLogged) {
      if (loginBtn) loginBtn.style.display = 'none';
      if (profBtnNav) profBtnNav.style.display = 'inline-block';
      if (profBtnMob) profBtnMob.style.display = 'block';

      if (adminList.includes(currentUser)) {
        document.getElementById('prof-admin-btn').style.display = 'block';
        document.getElementById('prof-admin-analytics-btn').style.display = 'block';
        document.getElementById('prof-admin-claims-btn').style.display = 'block';
      } else {
        document.getElementById('prof-admin-btn').style.display = 'none';
        document.getElementById('prof-admin-analytics-btn').style.display = 'none';
        document.getElementById('prof-admin-claims-btn').style.display = 'none';
      }

      updateChatBadge();
    } else {
      if (loginBtn) loginBtn.style.display = 'inline-block';
      if (profBtnNav) profBtnNav.style.display = 'none';
      if (profBtnMob) profBtnMob.style.display = 'none';
    }
  }
